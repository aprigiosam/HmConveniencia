...
def migrar_fornecedores_string_para_modelo(apps, schema_editor):
    ...
    fornecedores_strings = (
        Lote.objects.exclude(fornecedor_temp="")
        .values_list("fornecedor_temp", flat=True)
        .distinct()
    )
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nome",
                    models.CharField(max_length=200, verbose_name="Nome/Razão Social"),
                ),
                (
                    "nome_fantasia",
                    models.CharField(
